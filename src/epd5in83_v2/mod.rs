//! A simple Driver for the Waveshare 5.83" E-Ink Display (V2) via SPI
//!
//! # References
//!
//! - [Datasheet](https://www.waveshare.com/wiki/5.83inch_e-Paper_HAT)
//! - [Waveshare C driver](https://github.com/waveshare/e-Paper/blob/702def0/RaspberryPi%26JetsonNano/c/lib/e-Paper/EPD_5in83_V2.c)
//! - [Waveshare Python driver](https://github.com/waveshare/e-Paper/blob/702def0/RaspberryPi%26JetsonNano/python/lib/waveshare_epd/epd5in83_V2.py)
//!
...
/// EPD5in83 (V2) driver
///
pub struct EPD5in83<SPI, CS, BUSY, DC, RST> {
...
impl<SPI, CS, BUSY, DC, RST> InternalWiAdditions<SPI, CS, BUSY, DC, RST>
    for EPD5in83<SPI, CS, BUSY, DC, RST>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
    ...
    RST: OutputPin,
{
    fn init<DELAY: DelayMs<u8>>(
        ...
        // https://github.com/waveshare/e-Paper/blob/master/RaspberryPi%26JetsonNano/python/lib/waveshare_epd/epd5in83_V2.py
        // and as per specs:
        // https://www.waveshare.com/w/upload/6/60/5.83inch_e-Paper_V2_Specification.pdf
        ...
        self.cmd_with_data(spi, Command::TCON_RESOLUTION, &[0x02, 0x88, 0x01, 0xE0])?;
...
impl<SPI, CS, BUSY, DC, RST> EPD5in83<SPI, CS, BUSY, DC, RST>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
